  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        <p className="text-neutral-900 font-semibold text-lg mb-2">Describe your UI, watch it come to life</p>
        <p className="text-neutral-500 text-sm max-w-sm">Generate production-ready React components from plain English</p>
      </div>
    );
  }
